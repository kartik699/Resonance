...
export function DashboardSidebar() {
  ...
  const otherMenuItems: MenuItem[] = [
    ...
    },
    {
      ...
      icon: Headphones,
      url: 'mailto:resonance@gmail.com',
    },
  ];

  return (
    <Sidebar collapsible="icon">
      <SidebarHeader className="flex flex-col gap-4 pt4">
        <div className="flex items-center gap-2 pl-1 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:pl-0">
          ...
          />
          <span className="group-data-[collapsible=icon]:hidden font-semibold tracking-tighter text-lg text-foreground">
            Resonance
          </span>
